...
![image-20210807172133674](.\JVM学习之Java内存区域与内存溢出异常\3.png)
...
![img](.\JVM学习之Java内存区域与内存溢出异常\4.png)
...
1. 对分配内存空间的动作进行同步处理
   ...
   >
   > ![img](.\JVM学习之Java内存区域与内存溢出异常\7.png)
   >
   > 
   >
...
![img](.\JVM学习之Java内存区域与内存溢出异常\10.png)
...
![image-20210816151814262](.\JVM学习之Java内存区域与内存溢出异常\12.png)
