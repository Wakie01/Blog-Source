...
;
/*! pagemap v1.2.0 - https://larsjung.de/pagemap/ */ ! function (e, t) {
      ...
      e.exports = function (o, e) {
        ...
        function p() {
          m = W ? function (e) {
            ...
            }(W) : c(0, 0, T.scrollWidth, T.scrollHeight), x = W ? f(W) : c(O.pageXOffset, O.pageYOffset, T.clientWidth, T.clientHeight), b = P(m.w, m.h),
            function (e, t) {
              o.width = e, o.height = t, o.style.width = "".concat(e, "px"), o.style.height = "".concat(t, "px")
            }(m.w * b, m.h * b), H.setTransform(1, 0, 0, 1, 0, 0), H.clearRect(0, 0, o.width, o.height), H.scale(b, b), a(u(m, m), L.back), s(L.styles), a(u(x, m), _ ? L.drag : L.view)
        }
        ...
        function d(e) {
          ...
          W ? (W.scrollLeft = n, W.scrollTop = r) : O.scrollTo(n, r), p()
        }

        function h(e) {
          _ = !1, o.style.cursor = "pointer", E.style.cursor = "auto", n(O, "mousemove", d), n(O, "mouseup", h), d(e)
        }
        ...
        function y(e) {
          ...
          var t = f(o),
            n = u(x, m);
          w = ((e.pageX - t.x) / b - n.x) / n.w, j = ((e.pageY - t.y) / b - n.y) / n.h, (w < 0 || 1 < w || j < 0 || 1 < j) && (j = w = .5), o.style.cursor = "crosshair", E.style.cursor = "crosshair", i(O, "mousemove", d), i(O, "mouseup", h), d(e)
        }
        var g, v, m, x, b, w, j, O = M.window,
          ...
          P = (g = o.clientWidth, v = o.clientHeight, function (e, t) {
            return Math.min(g / e, v / t)
          }),
          W = L.viewport,
          _ = !1;
        return o.style.cursor = "pointer", i(o, "mousedown", y), i(W || O, "load resize scroll", p), 0 < L.interval && setInterval(function () {
          return p()
        }, L.interval), p(), {
          redraw: p
        }
